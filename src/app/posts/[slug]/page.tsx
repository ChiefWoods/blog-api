    ...
    <div className="flex w-full flex-col gap-2 bg-muted/35 px-4 py-10 sm:px-6 sm:py-14">
      ...
      <div className="mx-auto flex w-full max-w-3xl flex-col gap-12">
        <article className="mx-auto w-full max-w-2xl space-y-8">
          ...
          <section className="text-base leading-7 wrap-break-word text-foreground/95 sm:text-[1.075rem] sm:leading-9 [&_.react-tweet-theme]:my-8 [&_a]:font-medium [&_a]:wrap-break-word [&_a]:text-primary [&_a]:underline [&_a]:decoration-primary/70 [&_a]:underline-offset-4 [&_a]:transition-colors hover:[&_a]:decoration-primary [&_blockquote]:my-6 [&_blockquote]:border-l-2 [&_blockquote]:border-border [&_blockquote]:pl-5 [&_blockquote]:italic [&_h1]:font-heading [&_h1]:text-3xl [&_h1]:leading-tight [&_h1]:font-bold [&_h1]:tracking-tight sm:[&_h1]:text-4xl [&_h2]:mt-10 [&_h2]:font-heading [&_h2]:text-2xl sm:[&_h2]:text-3xl [&_h3]:mt-8 [&_h3]:font-heading [&_h3]:text-xl sm:[&_h3]:text-2xl [&_iframe]:my-8 [&_iframe]:aspect-video [&_iframe]:w-full [&_iframe]:rounded-md [&_iframe]:border [&_iframe]:border-border [&_ol]:my-7 [&_ol]:list-decimal [&_ol]:pl-7 [&_p]:mb-8 [&_p]:wrap-break-word [&_pre]:max-w-full [&_pre]:overflow-x-auto [&_pre]:overscroll-x-contain [&_pre>code]:block [&_pre>code]:w-max [&_pre>code]:min-w-full [&_table]:my-8 [&_table]:block [&_table]:max-w-full [&_table]:border-collapse [&_table]:overflow-x-auto [&_table]:whitespace-nowrap sm:[&_table]:w-full sm:[&_table]:whitespace-normal [&_table_p]:mb-0 [&_td]:border [&_td]:border-border [&_td]:px-3 [&_td]:py-2 [&_td]:wrap-break-word [&_th]:border [&_th]:border-border [&_th]:bg-muted/50 [&_th]:px-3 [&_th]:py-2 [&_th]:text-left [&_th]:wrap-break-word [&_ul]:my-7 [&_ul]:list-disc [&_ul]:pl-7 [&_ul[data-list-type='check']]:list-none [&_ul[data-list-type='check']]:pl-0 [&_ul[data-list-type='check']>li]:my-2">
            {renderedBody}
          </section>
